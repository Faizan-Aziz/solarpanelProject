                  ...
                  <div className="card h-100 border-0 shadow-sm">
                    <div className="card-body text-center p-4">
                      <div className="rounded-circle overflow-hidden mb-3 mx-auto" style={{width: '150px', height: '150px'}}>
                        <LazyLoadImage
                          src={`https://res.cloudinary.com/dovqlntrq/image/upload/w_600,h_400,c_fill,q_auto,f_auto/${solution.image}`}
                          alt={solution.title}
                      ...
                      <h3 className="h5 mb-3 text-success">{solution.title}</h3>
